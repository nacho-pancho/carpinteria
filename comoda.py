...
def escritorio_simple(
       ...
       obj = obj.add(tabla.translate((0,0,alto)),color=COLOR_FINGER,name=f"{nombre}_tabla")
       pies.append(pie)
       # 
       # lados
       # 
       prof_lado = prof - 2*margen
       ...
       obj = obj.add(lado_der.translate((ancho-margen-grosor_mdf,margen,0)),
                     color=COLOR_MDF,
       ...
       # fondo de bandeja
       #
       ancho_fondo = ancho-2*grosor_mdf-2*margen
       alto_fondo  = alto-grosor_finger-margen 
       fondo,pie   = piezas.crear_placa(orientacion="frente",
                                             ancho=alto_fondo, 
                                             largo=ancho_fondo,
                                             grosor=grosor_mdf, 
                                             material="MDF",
       ...
       pies.append(pie)
       obj.add(fondo.translate((margen+grosor_mdf,prof-grosor_mdf-margen,margen)),
