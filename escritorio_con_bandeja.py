...
def escritorio_con_bandeja(
        ...
        alto_rack, prof_rack,
        alto_cajonera, ancho_cajonera, num_cajones=4,
        margen=40,
        grosor_mdf=18,
        grosor_finger=20,
        gap_bandeja=50
       ...
       obj = obj.add(tabla.translate((0,0,alto_tabla)),color=COLOR_FINGER,name=f"{nombre}_tabla")
       pies.append(pie)
       # 
       # lados
       # 
       ...
       obj = obj.add(lado_izq.translate((margen,margen,0)),color=COLOR_MDF,name=f"{nombre}_lado_izq")
       pies.append(pie)
       ...
       fondo_rack,pie   = piezas.crear_placa(orientacion="frente",
                                             ancho=alto_rack, 
                                             largo=ancho_rack,
                                             grosor=grosor_mdf, 
                                             material="MDF",
       ...
       pies.append(pie)
       obj.add(fondo_rack.translate((margen+grosor_mdf,prof_tabla-grosor_mdf-prof_rack-margen,alto_tabla-alto_rack)),
               name=f"{nombre}_fondo_rack",
               color=COLOR_MDF)
       #
       # rack
       #
       rack,pie   = piezas.crear_placa(orientacion="horizontal",
                                             largo=prof_rack, 
                                             ancho=ancho_rack,
                                             grosor=grosor_mdf, 
                                             material="MDF",
                                             nombre=f"{nombre}_rack")
       obj.add(rack.translate((margen+grosor_mdf,prof_tabla-prof_rack-margen,alto_tabla-alto_rack)),
               name=f"{nombre}_rack",
               color=COLOR_MDF)
       pies.append(pie)
       ...
       obj.add(bandeja.translate((offset_hueco+GROSOR_GUIA,margen,alto_bandeja)),
               name=f"{nombre}_bandeja",
               color=COLOR_MDF)
       pies.append(pie)

       lado_ban_izq,pie   = piezas.crear_placa(orientacion="lado",
                                                ancho=ancho_bandeja,
                                                largo=prof_bandeja,
                                                grosor=grosor_mdf, 
                                                material="MDF",
                                                nombre=f"{nombre}_lado_ban_izq")
       obj.add(lado_ban_izq.translate((offset_bandeja,margen,alto_bandeja-ancho_bandeja)),
               name=f"{nombre}_lado_ban_izq",
               color=COLOR_MDF)
       pies.append(pie)
       
       lado_ban_der,pie   = piezas.crear_placa(orientacion="lado",
                                                ancho=ancho_bandeja,
                                                largo=prof_bandeja,
                                                grosor=grosor_mdf, 
                                                material="MDF",
                                                nombre=f"{nombre}_lado_ban_der")
       obj.add(lado_ban_der.translate((offset_bandeja+largo_bandeja-grosor_mdf,margen,alto_bandeja-ancho_bandeja)),
               name=f"{nombre}_lado_ban_der",
               color=COLOR_MDF)
       pies.append(pie)

       fondo_ban,pie   = piezas.crear_placa(orientacion="frente",
                                             ancho=ancho_bandeja, 
       ...
       pies.append(pie)
       obj.add(fondo_ban.translate((offset_bandeja+grosor_mdf,margen+prof_bandeja-grosor_mdf,alto_bandeja-ancho_bandeja)),
       ...
       guia_izq,pie = piezas.crear_guia("lado",ancho_guia,largo_guia,grosor_guia,nombre=f"{nombre}_guia_izq")
       obj.add(guia_izq.translate((margen+ancho_cajonera+2*grosor_mdf,margen,alto_bandeja-ancho_bandeja+(ancho_bandeja-ANCHO_GUIA)//2)),
               name=f"{nombre}_guia_izq",
               color=COLOR_GUIA)
       pies.append(pie)
       
       guia_der,pie = piezas.crear_guia("lado",ancho_guia,largo_guia,grosor_guia,nombre=f"{nombre}_guia_der")
       obj.add(guia_der.translate((margen+ancho_cajonera+2*grosor_mdf+GROSOR_GUIA+largo_bandeja,margen,alto_bandeja-ancho_bandeja+(ancho_bandeja-ANCHO_GUIA)//2)),
