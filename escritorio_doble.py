...
def escritorio(ancho_ppal,
       ...
       fondo_ppal,pie   = piezas.crear_placa(orientacion="frente",
                                             ...
                                             nombre="fondo_ppal")
       pies.append(pie)
       obj.add(fondo_ppal.translate((margen+grosor_mdf,prof_ppal-grosor_mdf-prof_bandeja-margen,alto_ppal-alto_fondo_ppal)),
               color=color_mdf)
       #
       # bandeja
       #
       bandeja,pie   = piezas.crear_placa(orientacion="horizontal",
                                             ...
                                             material="MDF",
                                             nombre="bandeja")
       obj.add(bandeja.translate((margen+grosor_mdf,prof_ppal-prof_bandeja-margen,alto_ppal-alto_fondo_ppal)),
               color=color_mdf)
       pies.append(pie)
       #
       # pieza secundaria
       ...
       # tabla sec
       #
       tabla_sec,pie  = piezas.crear_placa(orientacion="horizontal",
                                            ancho=ancho_sec,
                                            largo=prof_sec, 
                                            grosor=grosor_finger,
                                            material="FIN",
       ...
       # lados
       # 
       lado_sec_izq,pie   = piezas.crear_placa(orientacion="lado",
                                                ancho=alto_sec,
       ...
       fondo_sec,pie   = piezas.crear_placa(orientacion="frente",
                                             ancho=alto_fondo_sec, 
                                             largo=ancho_fondo_sec,
                                             grosor=grosor_mdf, 
                                             material="MDF",
                                             nombre="fondo_sec")
       fondo_sec = fondo_sec.translate((ancho_sec-margen-ancho_fondo_sec,margen-grosor_mdf,alto_sec-alto_fondo_sec))
       pies.append(pie)
       #
       # rotamos y agregamos la pieza secundaria
       #
       
       tabla_sec = tabla_sec.rotate(piezas.ZERO,piezas.ZAXIS,-90)
       obj = obj.add(tabla_sec,color=color_fin)
       lado_sec_izq = lado_sec_izq.rotate(piezas.ZERO,piezas.ZAXIS,-90)
       obj = obj.add(lado_sec_izq,color=color_mdf)
       lado_sec_med = lado_sec_med.rotate(piezas.ZERO,piezas.ZAXIS,-90)
       obj = obj.add(lado_sec_med,color=color_mdf)
       lado_sec_der = lado_sec_der.rotate(piezas.ZERO,piezas.ZAXIS,-90)
       obj = obj.add(lado_sec_der,color=color_mdf)
       fondo_sec = fondo_sec.rotate(piezas.ZERO,piezas.ZAXIS,-90)
...
res,pies = escritorio(ancho_ppal, alto_ppal, prof_ppal,
                      alto_fondo_ppal,
                      ancho_sec,alto_sec,prof_sec,
                      alto_fondo_sec,
                      ancho_cajones)
vis.show(res)
piezas.lista(pies)
