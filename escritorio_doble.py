...
def escritorio(
    ...
    # tabla ppal
    #
    tabla_ppal, pie = carpinteria.crear_placa_cq(
    ...
    # lados
    #
    lado_ppal_izq, pie = carpinteria.crear_placa_cq(
        orientacion="lado",
        ancho=alto_ppal,
    ...
    # fondo
    #
    fondo_ppal, pie = carpinteria.crear_placa_cq(
        orientacion="frente",
    ...
    # bandeja
    #
    bandeja, pie = carpinteria.crear_placa_cq(
        orientacion="horizontal",
        largo=prof_bandeja,
    ...
    # tabla sec
    #
    tabla_sec, pie = carpinteria.crear_placa_cq(
        orientacion="horizontal",
        ancho=ancho_sec,
        largo=prof_sec,
        grosor=grosor_finger,
    ...
    # lados
    #
    lado_sec_izq, pie = carpinteria.crear_placa_cq(
        orientacion="lado",
        ancho=alto_sec,
    ...
    fondo_sec, pie = carpinteria.crear_placa_cq(
        orientacion="frente",
