...
def mdf(name, thickness, face_orientation):
    """
    ...
    return Board(name=name,material=MDF_MATERIAL,thickness=thickness,coating=coating,face_orientation=face_orientation)
...
def build_drawer(size:Size):
    ...
    left_side = mdf("left_side",15,X_COORD)
    cons = LayoutConstraints()
    ...
    right_side = mdf("right_side",15,X_COORD)
    cons = LayoutConstraints()
